        ...
        if (unregisteredMembers.length > 0) {
          ...
          for (const member of unregisteredMembers) {
            try {
              ...
              const whatsappMessage = `${adminName} ne aapko Bhishi group '${group.name}' me add kiya hai 💸 App download karo aur start karo https://play.google.com/store/apps/details?id=com.bhishiapp.mobile`;
