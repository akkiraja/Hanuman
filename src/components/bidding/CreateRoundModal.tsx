        ...
        <View style={[styles.overlay, { backgroundColor: isDark ? 'rgba(0,0,0,0.7)' : 'rgba(248,250,252,0.5)' }]}>
          <View style={styles.content}>
            ...
            <View style={styles.body}>
              ...
              {/* Round Details - Static */}
              <View style={[styles.previewSection, styles.validPreview]}>
                ...
                <View style={styles.previewRow}>
                  ...
                  <Text style={styles.previewValue}>₹{parsedPrize > 0 ? parsedPrize.toLocaleString() : '0'}</Text>
                </View>
