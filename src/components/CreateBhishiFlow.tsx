...
import { Users, IndianRupee, Calendar, CreditCard, ArrowRight, ArrowLeft, Settings, Zap, TrendingUp } from 'lucide-react-native';
...
const STEPS = [
  ...
  { id: 5, title: 'UPI ID', icon: CreditCard, subtitle: 'Add your UPI ID for payments' },
];
...
export default function CreateBhishiFlow({ visible, onClose, onComplete }: CreateBhishiFlowProps) {
  ...
  const renderStep1 = () => (
    <View style={styles.stepContent}>
      ...
      <Text style={styles.stepMainTitle}>Choose your Bhishi type</Text>
      <Text style={styles.stepMainSubtitle}>Select how winners will be determined in your group</Text>
      ...
      <View style={styles.groupTypeOptions}>
        ...
        >
          <View style={[
            ...
            <TrendingUp size={24} color={formData.groupType === 'lucky_draw' ? Colors.background : Colors.primary} />
          </View>
          <Text style={[
          ...
          <Text style={styles.groupTypeDescription}>
            Traditional bhishi where winners are selected randomly by luck
          </Text>
        </TouchableOpacity>
        ...
        >
          <View style={[
            ...
            <Zap size={24} color={formData.groupType === 'bidding' ? Colors.background : Colors.primary} />
          </View>
          <Text style={[
            styles.groupTypeTitle,
          ...
          <Text style={styles.groupTypeDescription}>
            Members bid to win - lowest bid gets the pool
          </Text>
        </TouchableOpacity>
      </View>
    </View>
    ...
    <View style={styles.stepContent}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput
          ...
          placeholder="e.g., Friends Committee, Office Bhishi"
          placeholderTextColor={Colors.textSecondary}
          autoFocus
        />
        <Text style={styles.inputHint}>Choose a name that your group will easily recognize</Text>
      </View>
    </View>
  );
  ...
  const renderStep3 = () => (
    <View style={styles.stepContent}>
      ...
      <View style={styles.inputContainer}>
        ...
        <Text style={styles.inputHint}>Amount each member will contribute monthly</Text>
        
        {formData.monthlyAmount > 0 && (
          <View style={styles.amountPreview}>
            <View style={styles.previewRow}>
              <Text style={styles.previewLabel}>Per Member:</Text>
    ...
    return (
      <View style={styles.stepContent}>
        ...
        <View style={styles.dateSection}>
          <Text style={styles.inputLabel}>{formData.groupType === 'bidding' ? 'Bidding Day' : 'Draw Day'}</Text>
          <Text style={styles.inputHint}>
            Choose which day of the month the {formData.groupType === 'bidding' ? 'bidding round' : 'lucky draw'} will happen
          </Text>
          ...
          <View style={styles.drawDatePreview}>
            ...
            <View style={styles.previewContent}>
              <Text style={styles.previewTitle}>
                {formData.groupType === 'bidding' ? 'Bidding Schedule' : 'Lucky Draw Schedule'}
              </Text>
              <Text style={styles.previewText}>
                Every {formData.drawDay}{getOrdinal(formData.drawDay)} of the month
              </Text>
            </View>
          </View>
        </View>
